        ...
        >
            <Box sx={style}>
                <Grid container spacing={0}>
                    ...
                    <Grid item xs={9} sx={{ marginLeft: 0 }}>
                        <Box sx={{ bgcolor: "white" }}>
                            Imię: xxx xxxxxxxx<br />
                            Wiek: x lat<br />
                            Grzeczność: x<br />
                            Kraj: x<br />
                            Miasto: x<br />
